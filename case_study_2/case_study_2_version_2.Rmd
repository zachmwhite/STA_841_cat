...
samp.draws = posterior_samples(final.model)
...
My criterion for the best: Lowest upper credible interval bound for the ratio.  Values certainty and exceeding expectations.  Pielman or something
```{}
